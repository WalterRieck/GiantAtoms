...
# Construct single photon GA object GA
giantAtom = GA(N, J, nAtoms, [[g, g]], [delta], CouplePoints)
...
# Calculate dynamics for level e
...
# Calculate the site dynamics for the g levle
